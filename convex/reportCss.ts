...
.rt-concept-fullstage{position:relative;height:0;overflow:visible}.rt-concept-full{position:fixed;inset:0;z-index:50;display:none;flex-direction:column;overflow-y:auto;background:var(--co-bg);color:var(--co-text);font-family:var(--co-font,sans-serif);padding:0;margin:0}.rt-concept-full:target{display:flex;animation:rt-concept-rise .28s ease-out}.rt-concept-full-nav{display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:16px;padding:16px clamp(20px,4vw,40px);border-bottom:1px solid color-mix(in srgb,currentColor 12%,transparent);position:sticky;top:0;z-index:2;background:inherit}.rt-concept-full-back{text-decoration:none;font-size:13px;font-weight:600;padding:8px 12px;border-radius:999px;background:color-mix(in srgb,currentColor 8%,transparent);color:inherit}.rt-concept-full-brand{display:inline-flex;align-items:center;gap:10px;font-weight:700;font-size:16px;justify-self:center}.rt-concept-full-mark{width:28px;height:28px;border-radius:8px;display:inline-grid;place-items:center;font-weight:800;font-size:14px}.rt-concept-full-links{display:inline-flex;gap:4px}.rt-concept-full-links a{text-decoration:none;color:inherit;padding:8px 12px;border-radius:999px;font-size:13px;font-weight:600;opacity:.78}.rt-concept-full-hero{display:flex;flex-direction:column;gap:16px;padding:clamp(48px,9vw,110px) clamp(20px,4vw,40px) clamp(36px,6vw,64px);max-width:1080px;width:100%;margin:0 auto}.rt-concept-full-eyebrow{font-size:12px;font-weight:700;letter-spacing:.16em;text-transform:uppercase;margin:0}.rt-concept-full-title{font-size:clamp(36px,6vw,60px);line-height:1.05;letter-spacing:-.02em;font-weight:600;margin:0;max-width:22ch}.rt-concept-full-sub{font-size:clamp(17px,1.6vw,19px);line-height:1.6;margin:0;max-width:58ch;opacity:.85}.rt-concept-full-cta{align-self:flex-start;display:inline-flex;align-items:center;gap:10px;padding:14px 22px;border-radius:999px;font-weight:700;font-size:15px;text-decoration:none;margin-top:12px}.rt-concept-full-proofs{padding:clamp(24px,4vw,48px) clamp(20px,4vw,40px);max-width:1080px;width:100%;margin:0 auto;border-top:1px solid color-mix(in srgb,currentColor 10%,transparent);border-bottom:1px solid color-mix(in srgb,currentColor 10%,transparent)}.rt-concept-full-proofs-grid{display:grid;gap:16px;grid-template-columns:1fr}.rt-concept-full-proof{display:flex;flex-direction:column;gap:4px;padding:16px 0}.rt-concept-full-proof-value{font-size:clamp(32px,4vw,44px);font-weight:600;line-height:1;letter-spacing:-.02em}.rt-concept-full-proof-label{font-size:13px;letter-spacing:.04em;text-transform:uppercase;opacity:.7}.rt-concept-full-projects{padding:clamp(36px,6vw,64px) clamp(20px,4vw,40px);max-width:1080px;width:100%;margin:0 auto}.rt-concept-full-h2{font-size:clamp(24px,3vw,32px);line-height:1.2;letter-spacing:-.01em;font-weight:600;margin:0 0 24px}.rt-concept-full-project-list{list-style:none;margin:0;padding:0;display:grid;gap:0;border-top:1px solid color-mix(in srgb,currentColor 12%,transparent)}.rt-concept-full-project{display:grid;grid-template-columns:48px 1fr auto;gap:16px;align-items:center;padding:18px 0;border-bottom:1px solid color-mix(in srgb,currentColor 10%,transparent);font-size:clamp(16px,1.4vw,18px)}.rt-concept-full-project-num{font-weight:700;letter-spacing:.04em;font-size:14px}.rt-concept-full-project-title{font-weight:500}.rt-concept-full-project-tag{font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;padding:4px 10px;border-radius:999px;white-space:nowrap}.rt-concept-full-footer{display:flex;flex-direction:column;gap:12px;padding:clamp(40px,6vw,64px) clamp(20px,4vw,40px) clamp(56px,8vw,96px);max-width:1080px;width:100%;margin:0 auto;border-top:1px solid color-mix(in srgb,currentColor 12%,transparent)}.rt-concept-full-footer-tag{font-size:14px;letter-spacing:.04em;opacity:.78;margin:0;text-transform:uppercase}.rt-concept-full-footer-phone{font-size:clamp(36px,5vw,56px);font-weight:600;letter-spacing:-.02em;text-decoration:none;color:inherit;line-height:1}.rt-concept-full--trust{--co-bg:#f7f1e6}.rt-concept-full--local{--co-bg:#0f1218;--co-text:#f4f5f7}.rt-concept-full--premium{--co-bg:#faf8f3;--co-text:#1c1c20}`;
};
